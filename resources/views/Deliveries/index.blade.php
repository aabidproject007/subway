                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>In-process</td>
                                    <td>
                                        <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button" aria-expanded="false">Action Button <span class="caret"></span>
                                        </button>
                                        <ul role="menu" class="dropdown-menu">
                                            <li><a href="javscript:;" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modalEdit" onclick="myEdit('1')" ><i class="fa fa-pencil"></i> Change Status</a>
                                            </li>
                                            <li><a href="javscript:;" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modalEdit" onclick="myEdit('1')" ><i class="fa fa-pencil"></i> Assign to</a>
